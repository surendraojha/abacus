...
<div id="container">
	...
	<p class="first-para"> @for($i=0;$i<15;$i++) &nbsp; @endfor<strong>Name of Insured:</strong> {{ $bank->name_of_insured}}</p>
	<p class="first-para"> @for($i=0;$i<13;$i++) &nbsp; @endfor<strong>Address of Insured:</strong> {{ $bank->address_of_insured}} </p>
	<p class="first-para"> @for($i=0;$i<12;$i++) &nbsp; @endfor<strong>Amount of Transaction:</strong>{{ $bank->amt_of_transaction}}</p>
	<h2 class = "method">Method of Payment </h2>
	<p class="first-para"> @for($i=0;$i<15;$i++) &nbsp; @endfor Bank Account Number:{{$bank->bank_ac_no}}</p>
	<p class="first-para"> @for($i=0;$i<17;$i++) &nbsp; @endfor Routing Number:{{$bank->routing_no}}</p>
	...
	<div class="footer">
		<p id='signature'>Signature of Insured: {{$bank->signature}} 
		@for($i=0;$i<20;$i++) &nbsp; @endfor Date:{{$bank->submitted_date }}</p>
	</div>
